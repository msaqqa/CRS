...
const Header = (props) => {
  ...
  type==="2"? (userType = "Employee", dashboardUrl = "/employee/dashboard", profileSettingurl = "/employee/profile") :
  type==="1"? (userType = "Employer", dashboardUrl = "/employer/dashboard", profileSettingurl = "/employer/profile-setting") :
  type==="0"? (userType = "Admin") : null;
